...
public abstract class MySQLContainerTest {
    ...
    static void registerDataSource(DynamicPropertyRegistry registry) {
        ...
        // 커넥션 풀 크기는 application.yml 기본값(30)을 쓴다.
        // 부하 데모(BurstLoadSeatReservationTest)만 자체 @DynamicPropertySource로 작게 덮어쓴다.
    }

    @Autowired
    protected SeatReservationRepository seatReservationRepository;
